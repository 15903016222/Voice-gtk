...
static CONST_STRING_ENUM menu940_dict[] = {	_STRING_Software_Update ,_STRING_Hardware_Update ,_STRING_Reset_Config ,_STRING_Program_Time ,_STRING_NULL ,_STRING_NULL    };
